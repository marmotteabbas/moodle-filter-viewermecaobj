...
parse_obj = function(s)
{
	var obj_string=arrayBufferToString(s);
		...
		parseVertexIndex = function( index ) {
		...
		parseNormalIndex = function( index ) {
		...
		add_face = function( a, b, c, normals_inds ) {
		...
		handle_face_line = function(faces, uvs, normals_inds) {
